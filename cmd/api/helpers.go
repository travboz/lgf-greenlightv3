...
func (app *application) writeJSON(w http.ResponseWriter, status int, data envelope, headers http.Header) error {
	// Encode to JSON
	js, err := json.MarshalIndent(data, "", "\t") // use MarshalIndent for nicer formatting. NOTE: slight performance hit, return to json.Marshal if resource constrained.
	if err != nil {
		return err
	}
...
func (app *application) readJSON(w http.ResponseWriter, r *http.Request, dst any) error {
	...
	if err != nil {
		...
		switch {
		// to check whether a wrapped error `has` the type we're looking for
