...
func (r Runtime) MarshalJSON() ([]byte, error) {
	// Create a string containing the movie runtime in our chosen format
...
func (r *Runtime) UnmarshalJSON(jsonValue []byte) error {
	...
	// Otherwise, parse the string containing the number into an int32. If this fails, return the ErrInvalidRuntimeFormat error.
