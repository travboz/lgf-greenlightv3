...
func (p *password) Matches(plaintextPassword string) (bool, error) {
	...
	if err != nil {
		switch {
		// If they don’t match, then it will return a bcrypt.ErrMismatchedHashAndPassword error.
		case errors.Is(err, bcrypt.ErrMismatchedHashAndPassword):
			return false, nil // passwords don't match
		default:
			return false, err // actual error when comparing
		}
	}
	// passwords match
	return true, nil
...
func ValidateUser(v *validator.Validator, user *User) {
	...
	// If the plaintext password is not nil, call the ValidatePassword() helper.
